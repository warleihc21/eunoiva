...
msgstr "Nome de usuário não pode ser utilizado. Por favor, use outro nome de usuário."
...
"authentication."
msgstr "Você não pode adicionar um endereço de e-mail a uma conta protegida por autenticação de dois fatores."
...
"enabled."
msgstr "Você não pode gerar códigos de recuperação sem ter a autenticação de dois fatores ativada."

#: mfa/adapter.py:42
msgid ""
"You cannot activate two-factor authentication until you have verified your "
"email address."
msgstr "Você não pode ativar a autenticação de dois fatores até que tenha verificado seu endereço de e-mail."
...
msgstr "Ativar a operação sem senha permite que você faça login apenas com esta chave, mas impõe requisitos adicionais, como biometria ou proteção com PIN."
...
msgstr "Uma conta já existe com este endereço de e-mail. Faça login nessa conta primeiro e depois conecte sua conta %s."
...
msgstr "Resposta inválida ao obter o token de solicitação de \"%s\". A resposta foi: %s."
...
"enter it soon."
msgstr "Enviamos um código para %(email_link)s. O código expira em breve, então insira-o logo."
...
"account:"
msgstr "Você está recebendo este e-mail porque a seguinte alteração foi feita em sua conta:"
...
"- Date: %(timestamp)s"
msgstr ""
"Se você não reconhece essa alteração, por favor tome as devidas precauções de segurança imediatamente. A alteração em sua conta se origina de:\n"
"\n"
"- Endereço IP: %(ip)s\n"
...
msgstr ""
"Você está recebendo este e-mail porque o usuário %(user_display)s forneceu seu\n"
...
"browser window."
msgstr "Seu código de verificação de e-mail está listado abaixo. Por favor, insira-o na janela do seu navegador aberta."
...
"window."
msgstr "Seu código de entrada está listado abaixo. Por favor, insira-o na janela do seu navegador aberta."
...
msgstr "Este e-mail pode ser ignorado com segurança se você não iniciou esta ação."
...
msgstr ""
"Você está recebendo este e-mail porque você ou outra pessoa solicitou a redefinição de senha para sua conta de usuário.\n"
"Este e-mail pode ser ignorado com segurança se você não solicitou a redefinição de senha. Clique no link abaixo para redefinir sua senha."
...
msgstr ""
"Você está recebendo este e-mail porque você, ou outra pessoa, tentou acessar uma conta com o e-mail %(email)s. No entanto, não temos nenhum registro de tal conta em nosso banco de dados."
...
msgstr ""
"Por favor, confirme que <a href=\"mailto:%(email)s\">%(email)s</a> é um endereço de e-mail para o usuário %(user_display)s."
...
"account."
msgstr ""
"Incapaz de confirmar %(email)s porque já foi confirmado por uma conta diferente."
...
msgstr ""
"Este link de confirmação de e-mail expirou ou é inválido. Por favor, <a href=\"%(email_url)s\">emita uma nova solicitação de confirmação de e-mail</a>."
...
"up%(end_link)s first."
msgstr ""
"Se você ainda não criou uma conta, por favor, %(link)scadastre-se%(end_link)s primeiro."
...
msgstr ""
"Esqueceu sua senha? Insira seu endereço de e-mail abaixo e nós enviaremos um e-mail permitindo que você a redefina."
...
msgstr "Por favor, entre em contato conosco se tiver algum problema ao redefinir sua senha."
...
msgstr ""
"Enviamos um e-mail para você. Se você não o recebeu, por favor, verifique sua pasta de spam. Caso contrário, entre em contato conosco se não o receber em alguns minutos."
...
"a>."
msgstr ""
"O link de redefinição de senha era inválido, possivelmente porque já foi utilizado. Por favor, solicite uma <a href=\"%(passwd_reset_url)s\">nova redefinição de senha</a>."
...
"in."
msgstr "Você receberá um e-mail contendo um código especial para uma entrada sem senha."
...
msgstr ""
"Atualmente, você não tem nenhum endereço de e-mail configurado. Você deve realmente adicionar um endereço de e-mail para que possa receber notificações, redefinir sua senha, etc."
...
msgstr ""
"Esta parte do site exige que verifiquemos que você é quem afirma ser. Para esse fim, exigimos que você\n"
...
msgstr ""
"Enviamos um e-mail para você para verificação. Por favor, clique no link dentro desse e-mail. Se você não encontrar o e-mail de verificação em sua caixa de entrada principal, verifique sua pasta de spam. Caso contrário, entre em contato conosco se não o receber dentro de alguns minutos."
...
"email address</a>."
msgstr ""
"<strong>Nota:</strong> você ainda pode <a href=\"%(email_url)s\">alterar seu endereço de e-mail</a>."
...
"authenticator code:"
msgstr ""
"Sua conta está protegida por autenticação de dois fatores. Por favor, insira um código do autenticador:"
...
msgstr "Um novo conjunto de códigos de recuperação da autenticação de dois fatores foi gerado."
...
msgstr[0] "Há %(unused_count)s de %(total_count)s códigos de recuperação disponíveis."
msgstr[1] "Há %(unused_count)s de %(total_count)s códigos de recuperação disponíveis."
...
msgstr "Você está prestes a gerar um novo conjunto de códigos de recuperação para sua conta."
...
msgstr ""
"Para proteger sua conta com autenticação de dois fatores, escaneie o código QR abaixo com seu aplicativo autenticador. Em seguida, insira o código de verificação gerado pelo aplicativo abaixo."
...
"a later time."
msgstr "Você pode armazenar este segredo e usá-lo para reinstalar seu aplicativo autenticador posteriormente."
...
"sure?"
msgstr ""
"Você está prestes a desativar a autenticação baseada em aplicativo autenticador. Você tem certeza?"
...
"apart."
msgstr ""
"Você está prestes a criar uma chave de segurança para sua conta. Como você pode adicionar chaves adicionais posteriormente, pode usar um nome descritivo para diferenciar as chaves."
...
msgstr ""
"Ocorreu um erro ao tentar fazer login via sua conta de terceiros."
...
"accounts:"
msgstr ""
"Você pode fazer login em sua conta usando qualquer uma das seguintes contas de terceiros:"
...
msgstr ""
"Uma conta de terceiros de %(provider)s foi conectada à sua conta."
...
"account."
msgstr ""
"Uma conta de terceiros de %(provider)s foi desconectada de sua conta."
...
msgstr "Você está prestes a conectar uma nova conta de terceiros de %(provider)s."
...
msgstr "Você está prestes a fazer login usando uma conta de terceiros de %(provider)s."
...
msgstr ""
"Você decidiu cancelar o login em nosso site usando uma de suas contas existentes. Se isso foi um erro, por favor, continue para <a href=\"%(login_url)s\">fazer login</a>."
...
msgstr "Ou use sua conta do Google"
